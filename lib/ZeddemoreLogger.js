...
const { isMorganFormat, isWinstonLogLevelId, isWinstonTransportId, monkeyPatchConsole, winstonLogLevelName } = require('./logging');
require('./typedef');
...
class ZeddemoreLogger extends ZeddemoreBase {
    ...
    createLogger = (options) => {
        ...
        this.#logger = new ZeddemoreLoggerController({ logger: winstonLogger });
        return this.#logger;
    }
