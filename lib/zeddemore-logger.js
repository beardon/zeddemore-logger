...
class ZeddemoreLogger {
    ...
    static createRequestLogger = (requestId = null, ipAddress = null) => {
        const zeddemoreLogger = new ZeddemoreLogger();
        return zeddemoreLogger.#createRequestLogger(requestId, ipAddress);
    }
...
module.exports = {
    createLogger: ZeddemoreLogger.createLogger,
    createRequestLogger: ZeddemoreLogger.createRequestLogger,
