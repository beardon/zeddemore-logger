...
class ZeddemoreLogger {
    ...
    constructor(options) {
        ...
        this.defaultLabel = options.defaultLabel || pjson.name || 'zeddemore-logger';
        ...
        this.morganFormat = options.morganFormat || mf.BEARDON;
    ...
    createUserLogger(requestId = null, username = null, logLevel = this.logLevel, ipAddress = null) {
        requestId = requestId || this.#generateUuid();
        logLevel = logLevel || this.logLevel;
    ...
    initializeRequestLogger(req, res, next) {
    ...
    initializeUserLogger(req, res, next) {
        ...
        let userLogLevel = !_.isNil(user.logLevel) ? user.logLevel : this.logLevel;
